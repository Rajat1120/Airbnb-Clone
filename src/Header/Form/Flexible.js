...
const Flexible = ({ modalRef, handleInputField, flexibleRef }) => {
  ...
  } top-[72%] left-5 h-8 w-8  bg-white z-30 rounded-[50%] hover:scale-110 hidden hover:drop-shadow-md border-[1px] border-grey-dim-light `;

  let btnRightClassName = `absolute  ${
    scrollPosition > 758 ? "hidden" : "flex-center"
  } top-[72%] right-5 h-8 w-8  bg-white z-30 rounded-[50%] hover:scale-110 hover:drop-shadow-md border-[1px] border-grey-dim-light `;
